...
{
    public partial class Clients_ViewUserControl : UserControl
    {
        ...
        public Clients_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Clients_ViewForm_Load;
        ...
        private void Clients_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Clients_ViewForm_Load;
            this.Disposed -= Clients_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new TopPageForm(new Clients_AddEditUserControl(DBT_Clients.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)), "Изменить").ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new TopPageForm(new Clients_AddEditUserControl(), "Добавить").ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Clients.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Clients_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
