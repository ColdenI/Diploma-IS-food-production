...
{
    public partial class Suppliers_ViewUserControl : UserControl
    {
        ...
        public Suppliers_ViewUserControl()
        {
            InitializeComponent();

            this.Load += Suppliers_ViewForm_Load;
        ...
        private void Suppliers_ViewForm_Disposed(object? sender, EventArgs e)
        {
            this.Load -= Suppliers_ViewForm_Load;
            this.Disposed -= Suppliers_ViewForm_Disposed;
            button_update.Click -= Button_update_Click;
        ...
        {
            new TopPageForm(new Suppliers_AddEditUserControl(DBT_Suppliers.GetById((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value)), "Изменить").ShowDialog();
            UpdateTable();
        }

        private void Button_create_Click(object? sender, EventArgs e)
        {
            new TopPageForm(new Suppliers_AddEditUserControl(), "Добавить").ShowDialog();
            UpdateTable();
        }
        ...
        private void Button_remove_Click(object? sender, EventArgs e)
        {
            ...
            int res = DBT_Suppliers.Remove((int)dataGridView.CurrentCell.OwningRow.Cells[0].Value);
        ...
        private void Suppliers_ViewForm_Load(object sender, EventArgs e) => UpdateTable();
